...
const ItemList = (props)=>{
    ...
    return (
     ...
     {itemCards.map((item)=>(
        ...
        <button className="absolute bottom-0 bg-white shadow-md hover:shadow-lg hover:font-bold w-20 ml-2 text-green-500 border p-1 rounded-md border-green-400  ">Add +</button>
        </div>
        </div>
        ))}
    </div>
